...
const Cardlist = ({checkboxchange,user,name,email,role,onDelete,usersSelected,setuserSelected}) => {
    
    
    
    
    const isChecked=(email)=> usersSelected.includes(email)?'bg-info text-white': ''
    

    
    return (
        <div className='container '  >
            <span className={isChecked(email)}>
                    <div className="row gy-5 bd p-2">
                        <div className ="col">
                            ...
                            <label className='col'>
                                <div className='container'>
                                    <div className='row'>
                                        ...
                                        <Link to={'/update'}><svg  xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-box-arrow-in-down-left mr link" viewBox="0 0 16 16">
